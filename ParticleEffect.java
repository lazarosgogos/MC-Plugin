...
import lazini.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	 ...
	 * @param requiresData
	 *                            Indicates whether additional data is required
	 *                            for this particle effect
	 * @param requiresWater
	 *                            Indicates whether water is required for this
	 ...
	 *                                      If the particle effect is not
	 *                                      supported by the server version
	 * @throws ParticleDataException
	 *                                      If the particle effect requires
	 *                                      additional data
	 * @throws IllegalArgumentException
	 *                                      If the particle effect requires
	 *                                      water and none is at the center
	 *                                      location
	 * @see ParticlePacket
	 ...
	 *                                      supported by the server version
	 * @throws ParticleDataException
	 *                                      If the particle effect does not
	...
	public static final class ParticlePacket {
		 ...
		 *                         Particle effect
		 * @param offsetX
		 *                         Maximum distance particles can fly away from
		 ...
		 *                         Amount of particles
		 * @param longDistance
		 *                         Indicates whether the maximum distance is
		 *                         increased from 256 to 65536
		 * @param data
		 *                         Data of the effect
		 * @throws IllegalArgumentException
		 *                                      If the speed is lower than 0 or
		 ...
		 *                                          if instantion fails due to
		 *                                          an unknown error
		 * @throws PacketSendingException
		 *                                          if sending fails due to an
		 *                                          unknown error
		 */
